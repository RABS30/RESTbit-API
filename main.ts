...
namespace esp {
    ...
    //% weight=30
    //% blockGap=8
    //% blockId=esp_is_esp_initialized
    //% block="ESP initialized"
    ...
    //% blockGap=40
    //% blockId=esp_init
    //% block="initialize ESP: Tx %tx Rx %rx Baudrate %baudrate"
    export function init(tx: SerialPin, rx: SerialPin, baudrate: BaudRate) {
        ...
        // Restore the ESP factory settings.
    ...
    /**
     * Return true if the ESP is connected to WiFi router.
     */
    //% weight=28
    //% blockGap=8
    //% blockId=esp_is_wifi_connected
